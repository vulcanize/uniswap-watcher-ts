...
import { ApolloClient, NormalizedCacheObject, split, HttpLink, InMemoryCache, DocumentNode } from '@apollo/client/core';
...
export class Client {
  ...
  async query (query: DocumentNode, variables: { [key: string]: any }): Promise<any> {
