...
export interface IndexerInterface {
  ...
  updateSyncStatusIndexedBlock (blockHash: string, blockNumber: number, skipCheck?: boolean): Promise<SyncStatusInterface>
  updateSyncStatusCanonicalBlock (blockHash: string, blockNumber: number, skipCheck?: boolean): Promise<SyncStatusInterface>
...
export interface DatabaseInterface {
  ...
  updateSyncStatusIndexedBlock (queryRunner: QueryRunner, blockHash: string, blockNumber: number, skipCheck?: boolean): Promise<SyncStatusInterface>;
  updateSyncStatusChainHead (queryRunner: QueryRunner, blockHash: string, blockNumber: number): Promise<SyncStatusInterface>;
  updateSyncStatusCanonicalBlock (queryRunner: QueryRunner, blockHash: string, blockNumber: number, skipCheck?: boolean): Promise<SyncStatusInterface>;
